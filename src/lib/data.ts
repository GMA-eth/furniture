...
export const categories: Category[] = [
  {
    ...
    image: "https://loremflickr.com/800/600/living-room,interior,modern?lock=50",
    productCount: 24,
  ...
  },
  {
    ...
    image: "https://loremflickr.com/800/600/bedroom,interior,cozy?lock=51",
    productCount: 18,
  ...
  },
  {
    ...
    image: "https://loremflickr.com/800/600/dining-room,interior,elegant?lock=52",
    productCount: 16,
  ...
  },
  {
    ...
    image: "https://loremflickr.com/800/600/home-office,interior,workspace?lock=53",
    productCount: 14,
  ...
  },
  {
    ...
    image: "https://loremflickr.com/800/600/patio,outdoor,furniture,garden?lock=54",
    productCount: 10,
...
export const products: Product[] = [
  {
    ...
    tags: ["bestseller", "new"],
    images: [
      { src: "https://loremflickr.com/1200/900/scandinavian,sofa,living-room?lock=1", alt: "Oslo Sofa in warm beige linen, front view", width: 1200, height: 900, isPrimary: true },
      { src: "https://loremflickr.com/1200/900/modern,sofa,interior?lock=2", alt: "Oslo Sofa side profile", width: 1200, height: 900 },
      { src: "https://loremflickr.com/1200/900/sofa,detail,wood?lock=3", alt: "Oslo Sofa detail of oak legs", width: 1200, height: 900 },
    ],
    colorVariants: [
      {
        name: "Warm Beige",
        hex: "#D4C5B9",
        images: [
          { src: "https://loremflickr.com/1200/900/beige,sofa,living-room?lock=4", alt: "Oslo Sofa in Warm Beige", width: 1200, height: 900, isPrimary: true },
        ],
      },
      {
        name: "Charcoal",
        hex: "#3D3D3D",
        images: [
          { src: "https://loremflickr.com/1200/900/gray,sofa,modern?lock=5", alt: "Oslo Sofa in Charcoal", width: 1200, height: 900, isPrimary: true },
        ],
      },
      {
        name: "Sage Green",
        hex: "#9CAF88",
        images: [
          { src: "https://loremflickr.com/1200/900/green,sofa,velvet?lock=6", alt: "Oslo Sofa in Sage Green", width: 1200, height: 900, isPrimary: true },
        ],
      },
    ],
  ...
  },
  {
    ...
    tags: ["bestseller"],
    images: [
      { src: "https://loremflickr.com/1200/1200/white,dresser,bedroom,furniture?lock=7", alt: "Hemnes 8-Drawer Dresser in white stain, front view", width: 1200, height: 1200, isPrimary: true },
      { src: "https://loremflickr.com/1200/1200/dresser,drawer,wood?lock=8", alt: "Hemnes dresser drawer detail", width: 1200, height: 1200 },
      { src: "https://loremflickr.com/1200/900/dresser,bedroom,interior?lock=9", alt: "Hemnes dresser in bedroom setting", width: 1200, height: 900 },
    ],
    colorVariants: [
      { name: "White Stain", hex: "#F5F0EB", images: [{ src: "https://loremflickr.com/1200/1200/white,dresser,furniture?lock=10", alt: "Hemnes Dresser in White Stain", width: 1200, height: 1200, isPrimary: true }] },
      { name: "Black-Brown", hex: "#2C1810", images: [{ src: "https://loremflickr.com/1200/1200/black,dresser,modern?lock=11", alt: "Hemnes Dresser in Black-Brown", width: 1200, height: 1200, isPrimary: true }] },
    ],
  ...
  },
  {
    ...
    tags: ["bestseller", "new"],
    images: [
      { src: "https://loremflickr.com/1200/800/walnut,dining-table,wood?lock=12", alt: "Vreta Dining Table with walnut top, front view", width: 1200, height: 800, isPrimary: true },
      { src: "https://loremflickr.com/1200/800/dining-table,modern,interior?lock=13", alt: "Vreta table detail showing walnut grain", width: 1200, height: 800 },
    ],
    colorVariants: [
      { name: "Walnut", hex: "#5C3A21", images: [{ src: "https://loremflickr.com/1200/800/walnut,table,wooden?lock=14", alt: "Vreta Table in Walnut", width: 1200, height: 800, isPrimary: true }] },
      { name: "Natural Oak", hex: "#C4A97D", images: [{ src: "https://loremflickr.com/1200/800/oak,dining-table,natural?lock=15", alt: "Vreta Table in Natural Oak", width: 1200, height: 800, isPrimary: true }] },
    ],
    sizeVariants: [
  ...
  },
  {
    ...
    tags: ["new"],
    images: [
      { src: "https://loremflickr.com/1200/800/walnut,desk,office?lock=16", alt: "Arkad Desk in walnut, front view with accessories", width: 1200, height: 800, isPrimary: true },
      { src: "https://loremflickr.com/1200/800/desk,cable-management,modern?lock=17", alt: "Arkad Desk detail showing cable management", width: 1200, height: 800 },
      { src: "https://loremflickr.com/1200/900/home-office,desk,interior?lock=18", alt: "Arkad Desk in home office setting", width: 1200, height: 900 },
    ],
    colorVariants: [
      { name: "Walnut", hex: "#5C3A21", images: [{ src: "https://loremflickr.com/1200/800/walnut,desk,wood?lock=19", alt: "Arkad Desk in Walnut", width: 1200, height: 800, isPrimary: true }] },
      { name: "White Oak", hex: "#D4C5B9", images: [{ src: "https://loremflickr.com/1200/800/white,oak,desk?lock=20", alt: "Arkad Desk in White Oak", width: 1200, height: 800, isPrimary: true }] },
    ],
  ...
  },
  {
    ...
    tags: [],
    images: [
      { src: "https://loremflickr.com/1200/900/outdoor,chair,patio,teak?lock=21", alt: "Terras Lounge Chair on patio, front view", width: 1200, height: 900, isPrimary: true },
      { src: "https://loremflickr.com/1200/900/teak,chair,outdoor-furniture?lock=22", alt: "Terras chair detail showing teak grain", width: 1200, height: 900 },
    ],
    colorVariants: [
      { name: "Sand", hex: "#D2B48C", images: [{ src: "https://loremflickr.com/1200/900/beige,outdoor,chair?lock=23", alt: "Terras Chair in Sand", width: 1200, height: 900, isPrimary: true }] },
      { name: "Navy", hex: "#1B2A4A", images: [{ src: "https://loremflickr.com/1200/900/navy,outdoor,chair,patio?lock=24", alt: "Terras Chair in Navy", width: 1200, height: 900, isPrimary: true }] },
      { name: "Terracotta", hex: "#CC4E2E", images: [{ src: "https://loremflickr.com/1200/900/terracotta,outdoor,chair?lock=25", alt: "Terras Chair in Terracotta", width: 1200, height: 900, isPrimary: true }] },
    ],
  ...
  },
  {
    ...
    tags: ["sale"],
    images: [
      { src: "https://loremflickr.com/1200/1200/round,coffee-table,ash,wood?lock=26", alt: "Lotta Coffee Table in natural ash, top view", width: 1200, height: 1200, isPrimary: true },
      { src: "https://loremflickr.com/1200/900/coffee-table,living-room?lock=27", alt: "Lotta Coffee Table in living room setting", width: 1200, height: 900 },
    ],
    colorVariants: [
      { name: "Natural Ash", hex: "#E8D5B7", images: [{ src: "https://loremflickr.com/1200/1200/ash,coffee-table,scandinavian?lock=28", alt: "Lotta Table in Natural Ash", width: 1200, height: 1200, isPrimary: true }] },
      { name: "Black Stain", hex: "#2C2C2C", images: [{ src: "https://loremflickr.com/1200/1200/black,coffee-table,round?lock=29", alt: "Lotta Table in Black Stain", width: 1200, height: 1200, isPrimary: true }] },
    ],
  ...
  },
  {
    ...
    tags: ["bestseller"],
    images: [
      { src: "https://loremflickr.com/1200/800/upholstered,bed,cream,headboard?lock=30", alt: "Nore Bed Frame in cream upholstery, front view", width: 1200, height: 800, isPrimary: true },
      { src: "https://loremflickr.com/1200/800/bed,tufted,headboard,bedroom?lock=31", alt: "Nore bed detail showing headboard tufting", width: 1200, height: 800 },
    ],
    colorVariants: [
      { name: "Cream", hex: "#F5F0EB", images: [{ src: "https://loremflickr.com/1200/800/cream,bed,upholstered?lock=32", alt: "Nore Bed in Cream", width: 1200, height: 800, isPrimary: true }] },
      { name: "Slate", hex: "#708090", images: [{ src: "https://loremflickr.com/1200/800/gray,bed,upholstered,slate?lock=33", alt: "Nore Bed in Slate", width: 1200, height: 800, isPrimary: true }] },
    ],
    sizeVariants: [
  ...
  },
  {
    ...
    tags: ["new"],
    images: [
      { src: "https://loremflickr.com/1200/1200/white,bookshelf,steel,modern?lock=34", alt: "Form Bookshelf in matte white, front view with books", width: 1200, height: 1200, isPrimary: true },
      { src: "https://loremflickr.com/1200/900/bookshelf,styled,interior?lock=35", alt: "Form Bookshelf styling inspiration", width: 1200, height: 900 },
    ],
    colorVariants: [
      { name: "Matte White", hex: "#F0F0F0", images: [{ src: "https://loremflickr.com/1200/1200/white,shelving,minimalist?lock=36", alt: "Form Bookshelf in Matte White", width: 1200, height: 1200, isPrimary: true }] },
      { name: "Sage", hex: "#9CAF88", images: [{ src: "https://loremflickr.com/1200/1200/green,bookshelf,sage?lock=37", alt: "Form Bookshelf in Sage", width: 1200, height: 1200, isPrimary: true }] },
      { name: "Terracotta", hex: "#CC4E2E", images: [{ src: "https://loremflickr.com/1200/1200/terracotta,shelf,colorful?lock=38", alt: "Form Bookshelf in Terracotta", width: 1200, height: 1200, isPrimary: true }] },
    ],
